...
--
-- Servidor: localhost
-- Tiempo de generación: 24-05-2023 a las 16:50:58
...
ALTER TABLE `user_notification`
  ADD PRIMARY KEY (`id`,`sourceid`,`targetid2`),
  ADD KEY `FKuser_notif8514` (`sourceid`),
  ADD KEY `FKuser_notif889263` (`targetid2`),
...
ALTER TABLE `user_notification`
  ...
  ADD CONSTRAINT `FKuser_notif889263` FOREIGN KEY (`targetid2`) REFERENCES `user` (`id`);
