...
var _relationship_status = require("./relationship_status");
...
function initModels(sequelize) {
  ...
  var relationship_status = _relationship_status(sequelize, DataTypes);
  ...
  user_follower.belongsTo(relationship_status, { as: "relationship_status", foreignKey: "relationship_statusid"});
  relationship_status.hasMany(user_follower, { as: "user_followers", foreignKey: "relationship_statusid"});
  user_following.belongsTo(relationship_status, { as: "relationship_status", foreignKey: "relationship_statusid"});
  relationship_status.hasMany(user_following, { as: "user_followings", foreignKey: "relationship_statusid"});
